...
public:
            ...
            vector<vector<string>> &res)
  {
    ...
    // general scenario -> check at every partition if pallindrome is possible or not
    // if possible, put it into path vector and check for the rest of the string..
    // if a solution, not found then back-track the steps
